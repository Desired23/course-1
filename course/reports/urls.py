...
from .views import (
    ...
    AdminReportItemDetailView,
    AdminReportListView,
    AdminReportMarkProcessedView,
    AdminReportMarkUnprocessedView,
...
urlpatterns = [
    ...
    path('reports/admin/items/<int:report_id>/', AdminReportItemDetailView.as_view(), name='admin-report-item-detail'),
    path('reports/admin/items/<int:report_id>/mark-processed/', AdminReportMarkProcessedView.as_view(), name='admin-report-mark-processed'),
    path('reports/admin/items/<int:report_id>/mark-unprocessed/', AdminReportMarkUnprocessedView.as_view(), name='admin-report-mark-unprocessed'),
