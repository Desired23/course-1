...
from .views import (
    ...
    AdminRevenueByCourseView,
    AdminRevenueByCategoryView,
    AdminRevenueByInstructorView,
    AdminSubscriptionMetricsView,
    AdminEarningPayoutMetricsView,
    AdminPromotionStatsView,
    AdminCreationStatsView,
    AdminBestSellingCoursesView,
    AdminBulkReportExportView,
...
urlpatterns = [
    ...
    path('admin/analytics/revenue-by-course/', AdminRevenueByCourseView.as_view(), name='admin-revenue-by-course'),
    path('admin/analytics/revenue-by-category/', AdminRevenueByCategoryView.as_view(), name='admin-revenue-by-category'),
    path('admin/analytics/revenue-by-instructor/', AdminRevenueByInstructorView.as_view(), name='admin-revenue-by-instructor'),
    path('admin/analytics/subscription-metrics/', AdminSubscriptionMetricsView.as_view(), name='admin-subscription-metrics'),
    path('admin/analytics/earning-payout/', AdminEarningPayoutMetricsView.as_view(), name='admin-earning-payout-metrics'),
    path('admin/analytics/promotions/', AdminPromotionStatsView.as_view(), name='admin-promotion-stats'),
    path('admin/analytics/creation/', AdminCreationStatsView.as_view(), name='admin-creation-stats'),
    path('admin/analytics/best-selling/', AdminBestSellingCoursesView.as_view(), name='admin-best-selling-courses'),
    path('admin/analytics/bulk-export/', AdminBulkReportExportView.as_view(), name='admin-bulk-report-export'),
    path('admin/analytics/revenue-export/', AdminRevenueExportView.as_view(), name='admin-revenue-export'),
    path('admin/export/users/', AdminUserExportView.as_view(), name='admin-user-export'),
