...
export const lessons = [
  ...
  { lesson_id: 1, coursemodule_id: 1, title: "Course Introduction", description: "Welcome to the course", content_type: "video", content: null, video_url: "https://res.cloudinary.com/dqzopvk2t/video/upload/v1780068574/course_lessons/course_sample_lesson.mp4", file_path: null, duration: 15, is_free: true, order: 1, status: "published", created_at: new Date(), updated_at: new Date() },
  { lesson_id: 2, coursemodule_id: 1, title: "What is Web Development?", description: "Overview of web development", content_type: "video", content: null, video_url: "https://res.cloudinary.com/dqzopvk2t/video/upload/v1780068574/course_lessons/course_sample_lesson.mp4", file_path: null, duration: 25, is_free: true, order: 2, status: "published", created_at: new Date(), updated_at: new Date() },
  { lesson_id: 3, coursemodule_id: 1, title: "Setting Up Your Environment", description: "Install necessary tools", content_type: "video", content: null, video_url: "https://res.cloudinary.com/dqzopvk2t/video/upload/v1780068574/course_lessons/course_sample_lesson.mp4", file_path: null, duration: 30, is_free: true, order: 3, status: "published", created_at: new Date(), updated_at: new Date() },
  ...
  { lesson_id: 5, coursemodule_id: 2, title: "HTML Structure", description: "Learn HTML document structure", content_type: "video", content: null, video_url: "https://res.cloudinary.com/dqzopvk2t/video/upload/v1780068574/course_lessons/course_sample_lesson.mp4", file_path: null, duration: 35, is_free: false, order: 1, status: "published", created_at: new Date(), updated_at: new Date() },
  { lesson_id: 6, coursemodule_id: 2, title: "HTML Elements", description: "Common HTML elements", content_type: "video", content: null, video_url: "https://res.cloudinary.com/dqzopvk2t/video/upload/v1780068574/course_lessons/course_sample_lesson.mp4", file_path: null, duration: 40, is_free: false, order: 2, status: "published", created_at: new Date(), updated_at: new Date() },
