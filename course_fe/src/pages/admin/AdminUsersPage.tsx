...
import { getAllUsers, adminUpdateUser, deleteUser as deleteUserApi } from '../../services/admin.api'
...
export function AdminUsersPage() {
      ...
      try {
        ...
        setUsers(data.map((u: UserItem) => {
          ...
          return {
            ...
            enrollments: 0,
            coursesCreated: ut === 'instructor' ? undefined : undefined,
  ...
  const handleUnbanUser = async (userId: string) => {
    try {
      ...
      toast.success('Đã mở cấm người dùng')
    } catch { toast.error('Thao tác thất bại') }
  }
