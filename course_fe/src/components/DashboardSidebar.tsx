...
export function DashboardSidebar({ type, className }: DashboardSidebarProps) {
  ...
  const instructorItems: SidebarItem[] = [
    ...
    { label: t("dashboard_sidebar.items.communication"), icon: <Bell className="h-5 w-5" />, href: "/instructor/communication" },
    { label: t("dashboard_sidebar.items.students"), icon: <UserCheck className="h-5 w-5" />, href: "/instructor/students" },
    { label: t("dashboard_sidebar.items.earnings"), icon: <DollarSign className="h-5 w-5" />, href: "/instructor/analytics" },
